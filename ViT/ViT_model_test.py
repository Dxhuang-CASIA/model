...
class DropPath(nn.Module): # Droppath
...
class MLP(nn.Module): # MSA后面接的MLP
...
class Vision_Transformer(nn.Module):
    def __init__(self, image_size = 224, patch_size = 16, in_channel = 3, num_classes = 1000, # ImageNet-1K
                 ...
                 qk_scale = None, representation_size = None, drop_ratio = 0., attn_drop_ratio = 0.,
