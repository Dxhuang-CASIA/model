...
def main(args):
    ...
    nw = min([os.cpu_count(), batch_szie if batch_szie > 1 else 0, 8]) # number of workers
...
if __name__ == '__main__':
    ...
    # 预训练权重路径
    parser.add_argument('--weights', type = str, default = '../Pre_Train_Param/jx_vit_base_patch16_224_in21k-e5005f0a.pth')
